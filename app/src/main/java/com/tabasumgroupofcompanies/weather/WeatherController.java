package com.tabasumgroupofcompanies.weather;
...
public class WeatherController extends AppCompatActivity {
    ...
    final String LOGCAT_TAG = "Tabasum";
    ...
    private void getWeatherForCurrentLocation() {
        ...
        Log.d(LOGCAT_TAG, "Location Provider used: " + mLocationManager.getProvider(LOCATION_PROVIDER).getName());
    ...
    private void letsDoSomeNetworking(RequestParams params_variable) {

        // AsyncHttpClient belongs to the loopj dependency.
        AsyncHttpClient client = new AsyncHttpClient();

        // Making an HTTP GET request by providing a URL and the parameters.
        client.get(WEATHER_URL, params_variable, new JsonHttpResponseHandler() {
            @Override
